...
#################################################################################
            ...
            pseduo_labels = np.load(f'E:\\OPV2V\\out_v2\\out_pseduo_labels_v2_{num_timestamp}.npy')
            pseduo_labels_error = np.load(f'E:\\OPV2V\\out_v2\\out_pseduo_labels_v2_{num_timestamp}.npy')
            ...
            np.save(f'E:\\OPV2V\\out_v2_ok\\out_pseduo_labels_with_score_v2_{num_timestamp}.npy', pseduo_labels_with_score)
            ...
            # np.save(f'E:\\OPV2V\\out_v4_error\\out_pseduo_labels_noise_with_score_v4_{num_timestamp}.npy', pseduo_labels_noise_with_score)
